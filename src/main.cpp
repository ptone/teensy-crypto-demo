...
static int TestRNG(uint8_t *dest, unsigned size) {
  ...
  // This function should be replaced with platform specific/HW RNG where possible
  while (size) {
    uint8_t val = 0;
...
// CBOR buffers Choose an array size of 256 and a starting address of zero
...
void setup() {
  ...
  // This is the P256 ec key standard
  const struct uECC_Curve_t * curve = uECC_secp256r1();

  char privKeyHex[] = "c9:3b:25:f0:de:87:61:54:74:fc:ab:7b:04:74:71:b7:2d:23:15:32:22:cb:21:78:16:2e:3d:f0:b1:cb:02:0d";
  char serverPublicHex[] = "b1:d2:08:07:70:64:03:c9:3d:5d:56:61:f7:d4:88:ca:20:de:fb:13:c0:74:db:d3:fe:31:b9:10:90:32:b4:4c:2a:89:93:d5:92:4d:dd:98:fc:2a:f4:18:8c:1b:54:de:b0:93:f7:ff:9e:b3:0b:41:2c:cb:db:a0:a7:94:08:3d";
  char* token = NULL; 
 

  // parse private string into byte array
  token = strtok(privKeyHex, ":");
  int ctr = 0;
  while (token != NULL) {
